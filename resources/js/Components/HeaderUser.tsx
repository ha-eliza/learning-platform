    ...
    return (
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
                <div className="w-16 h-16 rounded-2xl bg-blue-50 border border-blue-100 md:flex items-center justify-center text-blue-600 shadow-inner hidden">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        <Space size={8} className="flex items-center">
                            <Title
                                ...
                                className="!text-[16px] md:!text-3xl font-bold tracking-tight"
                            >
            ...
            <div className="flex items-center gap-6 border-t md:border-t-0 pt-4 md:pt-0 border-slate-100">
                <div className="text-center">
                    <div className="text-[1.2rem] md:text-2xl font-bold text-slate-800 font-mono">
